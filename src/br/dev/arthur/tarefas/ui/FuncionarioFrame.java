...
public class FuncionarioFrame {
	...
	private void criarTela(JFrame pai) {
		...
		btnSalvar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (sucesso) {
					...
					JOptionPane.showMessageDialog(telaFuncionario, "Ocorreu um erro na gravação. FAZ O L!!!\nTente novamente.\nSe o problema persistir entre em contaro com o suporte.");
				}
		...
		btnSair.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				int resposta = JOptionPane.showConfirmDialog(telaFuncionario, "Sair do sistema seu covarde?", "Atenção maricas", JOptionPane.YES_NO_OPTION);
				
				if (resposta == 0) {
				JOptionPane.showMessageDialog(telaFuncionario, "É uma bichona mesmo");
